...
exports.createConstructionQuotation = async (req, res) => {
    try {
        ...
        const mailOptions = {
            ...
            html: `<p>Hi Admin,</p><p>A new construction quotation(Id: ${construction._id}) has been created by ${construction.coordinator.name}.</p><p>Thanks,</p></br>Bold Portable`
        };
...
exports.createRecreationalSiteQuotation = async (req, res) => {
    try {
        ...
        const mailOptions = {
            ...
            html: `<p>Hi Admin,</p><p>A new recreational-site quotation(Id: ${recreationalSite._id}) has been created by ${recreationalSite.coordinator.name}.</p><p>Thanks,</p></br>Bold Portable`
        };
        mailer.sendMail(mailOptions);
...
exports.createDisasterReliefQuotation = async (req, res) => {
    try {
        ...
        const mailOptions = {
            ...
            html: `<p>Hi Admin,</p><p>A new disaster-relief quotation(Id: ${disasterRelief._id}) has been created by ${disasterRelief.coordinator.name}.</p><p>Thanks,</p></br>Bold Portable`
        };
        mailer.sendMail(mailOptions);
...
exports.createPersonalOrBusinessQuotation = async (req, res) => {
    try {
        ...
        const mailOptions = {
            ...
            html: `<p>Hi Admin,</p><p>A new personal-or-business quotation(Id: ${personalOrBusiness._id}) has been created by ${personalOrBusiness.coordinator.name}.</p><p>Thanks,</p></br>Bold Portable`
        };
        mailer.sendMail(mailOptions);
...
exports.createFarmOrchardWineryQuotation = async (req, res) => {
    try {
        ...
        const mailOptions = {
            ...
            html: `<p>Hi Admin,</p><p>A new farm-orchard-winery quotation(Id: ${farmOrchardWinery._id}) has been created by ${farmOrchardWinery.coordinator.name}.</p><p>Thanks,</p></br>Bold Portable`
        };
        mailer.sendMail(mailOptions);
...
exports.createEventQuotation = async (req, res) => {
    try {
        ...
        const mailOptions = {
            ...
            html: `<p>Hi Admin,</p><p>A new event quotation(Id: ${event._id}) has been created by ${event.coordinator.name}.</p><p>Thanks,</p></br>Bold Portable`
        };
        mailer.sendMail(mailOptions);
